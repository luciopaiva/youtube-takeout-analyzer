...
class WatchHistoryCache {
    ...
    map(fn) {
        return Object.values(this.videoInfoById).map(fn);
    }

    values() {
        return Object.values(this.videoInfoById);
    }

    getVideoDurationInMinutes(id, capAt = Number.POSITIVE_INFINITY) {
